...
| [0002](proposals/lip-0002.md) | Change to byte based block size limit | Iker Alustiza, Nazar Hussain | Standards Track | Replaced |
| [0003](proposals/lip-0003.md) | Uniform ordering of delegates list | Iker Alustiza | Standards Track | Replaced |
...
| [0008](proposals/lip-0008.md) | Remove pre-hashing for block and transaction signatures | Andreas Kendziorra | Standards Track | Replaced |
| [0009](proposals/lip-0009.md) | Mitigate transaction replay on different chains | Manu Nelamane Siddalingegowda, Iker Alustiza | Standards Track | Replaced |
...
| [0013](proposals/lip-0013.md) | Replace static fee system by dynamic fee system | Iker Alustiza | Standards Track | Replaced |
| [0014](proposals/lip-0014.md) | Introduce BFT consensus protocol | Jan Hackfeld | Standards Track | Replaced |
| [0015](proposals/lip-0015.md) | Enable transaction invalidation by using nonces instead of timestamps | Andreas Kendziorra | Standards Track | Replaced |
...
| [0017](proposals/lip-0017.md) | Make multisignature accounts more flexible, prevent spamming, and prevent signature mutability | Andreas Kendziorra | Standards Track | Replaced |
...
| [0019](proposals/lip-0019.md) | Use full SHA-256 hash of transaction header as transactionID | Andreas Kendziorra | Standards Track | Replaced |
| [0020](proposals/lip-0020.md) | Use full SHA-256 hash of block header as blockID | Andreas Kendziorra | Standards Track | Replaced |
| [0021](proposals/lip-0021.md) | Change to one vote per account | Jan Hackfeld | Standards Track | Withdrawn |
| [0022](proposals/lip-0022.md) | Use Randao-based scheme to include standby delegates and reorder delegate list | Iker Alustiza | Standards Track | Replaced |
| [0023](proposals/lip-0023.md) | Introduce vote locking periods and new vote weight definition | Maxime Gagnebin | Standards Track | Replaced |
| [0024](proposals/lip-0024.md) | Punish BFT violations | Maxime Gagnebin | Standards Track | Replaced |
| [0025](proposals/lip-0025.md) | Introduce minimum balance requirement for accounts | Iker Alustiza | Standards Track | Replaced |
| [0026](proposals/lip-0026.md) | Establish block validity by applying transactions sequentially | Maxime Gagnebin | Standards Track | Replaced |
| [0027](proposals/lip-0027.md) | A generic serialization method | Maxime Gagnebin, Andreas Kendziorra | Informational | Active |
| [0028](proposals/lip-0028.md) | Define schema and use generic serialization for transactions | Iker Alustiza | Standards Track | Replaced |
| [0029](proposals/lip-0029.md) | Define schema and use generic serialization for blocks | Alessandro Ricottone | Standards Track | Replaced |
