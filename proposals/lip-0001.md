...
The Title header precisely describes the proposal in brief. An example of a good title is “Change to byte based block size limit”. Generic titles such as “Improve P2P Layer” should be avoided as there could be multiple improvements of this aspect of the protocol in the future and it is unclear what specific aspect of the protocol the proposal suggests to change. Note that once a pull request is opened on Github, the LIP editor will also review that the title of a LIP satisfies these guidelines and adjust it at his/her discretion.
