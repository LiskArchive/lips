...
The Discussions-To header contains a link to the discussion of the LIP in [Lisk Research][lisk-research].
...
A process LIP may change status from Draft to Active when it achieves rough consensus on [Lisk Research][lisk-research]. Such a proposal is said to have rough consensus if it has been open to discussion on [Lisk Research][lisk-research] for at least one month, and no person maintains any unaddressed substantiated objections to it. Addressed or obstructive objections may be ignored/overruled by general agreement that they have been sufficiently addressed, but clear reasoning must be given in such circumstances.
...
[lisk-research]:    https://research.lisk.io/                                       "Lisk Research"
