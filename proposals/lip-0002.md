...
* Blockchain size will grow a **maximum** of 47.3 GiB per year.
...
* The payload of a block must not weigh more than 15 KiB (15 * 1024 bytes). If a delegate generates a bigger block, it should be deemed invalid.
