...
Discussions-To: https://research.lisk.com/t/introduce-robust-peer-selection-and-banning-mechanism/
Status: Active
...
| `postNodeInfo`                 | `updateMyself`    | Event    | Sends the latest information about the node.                                                                  |
| `getNodeInfo`                  | `status`          | RPC      | Gets node information after connection initialization.                                                        |
| `getPeers`                     | `list`            | RPC      | Gets a list of IP addresses and port number of peers.                                                         |
...
| ------------------------------ | ------------------------------------------------------ | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `postNodeInfo`                 | Invalid schema                                         | 100           | Honest peers should send valid `postNodeInfo` messages.                                                                                                                             |
| `postNodeInfo`                 | Invalid attribute values                               | 100           | Honest peers should send valid `postNodeInfo` messages.                                                                                                                             |
| `postNodeInfo`                 | >4 send status message in a 10 s time window           | 10            | The number of `postNodeInfo` messages by an honest peer in a 10 s time window is throttled at 3.                                                                                    |
...
| `getNodeInfo`                  | Invalid schema                                         | 100           | Honest peers should send valid `getNodeInfo` messages.                                                                                                                              |
| `getNodeInfo`                  | Invalid attribute values                               | 100           | Honest peers should send valid `getNodeInfo` messages.                                                                                                                              |
| `getNodeInfo`                  | More than one node header message for one connection   | 10            | There should only be one `getNodeInfo` message when the connection is established.                                                                                                |
...
I would like to thank Jonathan Gros-Dubois (author of [SocketCluster](https://socketcluster.io)) for a lot of fruitful discussions and good suggestions for this LIP as well as many helpful explanations regarding our current implementation.
