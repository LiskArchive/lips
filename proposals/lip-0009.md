...
- `H()` - The cryptographic hash function **SHA2-256**.
...
- Version = `'2.0'`
- Hash function `H()` is SHA2-256

With these parameters, the network identifier will be calculated as: `network_ID = SHA2-256(NH + ‘Lisk’ + ‘2.0’)= 'b11ff2d5f4a03c554260992d0b7cd1338b7d0548d960057771cc812d955334b0'`
