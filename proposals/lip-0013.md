...
- Fees are not shared equally among delegates every round anymore. The minimum fee for each transaction will be _burnt_, whereas the remaining fee will be assigned the delegate that forged the block.
...
![reward3](lip-0013/reward_3.png)

![reward2](lip-0013/reward_2.png)

![reward1](lip-0013/reward_1.png)
