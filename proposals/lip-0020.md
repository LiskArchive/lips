...
Since it is safe to assume that blockID collisions will not occur with the proposed length, the blockID uniqueness check is not required anymore during transaction validation and will be removed for this reason.
