...
1. The `trsData.asset` property is serialized to bytes according to the corresponding  `asset` property schema specified by the combination of `trsData.moduleID` and `trsData.assetID` properties (see [below](#transactionSchema-schema)) as specified in [LIP 0033](https://github.com/LiskHQ/lips/blob/master/proposals/lip-0033.md#specification).
...
2. The bytes value of the `trsData.asset` property is deserialized according to the corresponding `asset` property schema specified by the combination of `trsData.moduleID` and `trsData.assetID` properties as specified in [LIP 0033](https://github.com/LiskHQ/lips/blob/master/proposals/lip-0033.md#specification).
