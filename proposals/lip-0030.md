...
5. `dpos`: This module contains the properties relative to the [Lisk Delegated Proof of Stake](https://github.com/LiskHQ/lips/blob/master/proposals/lip-0023.md) protocol.
