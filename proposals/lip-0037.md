...
| `MESSAGE_TAG_MULTISIG_REG`      | bytes | "LSK_RMSG_" as ASCII-encoded literal               | Message tag for the signatures contained in the [register multisignature command](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0041.md#RegisterMultisignatureGroup). |
