...
| **message type**                                                                                                                                   | **tag**   |
|----------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| transaction with serialization as specified in [LIP 0028](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0028.md#transactionschema-schema) | "LSK_TX_" |
| block header with serialization as specified in [LIP 0029](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0029.md#blockheader-schema)      | "LSK_BH_" |
