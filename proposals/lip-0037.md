...
| `MESSAGE_TAG_CHAIN_REG_MESSAGE` | `bytes` | "LSK_CHAIN-REGISTRATION_" as ASCII-encoded literal | Message tag for the signatures contained in the [chain registration message](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0043.md). |
