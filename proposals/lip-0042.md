...
Created: 2021-08-03
Updated: 2021-09-24
Requires: 0042, Introduce BFT module, Define state and state transitions of Token module
```
...
* After applying the block, a certain quantity of the native token of the blockchain is minted and assigned to the block generator. The exact amount assigned to the block generator, i.e., the reward, is calculated depending on the rules of the [random module][research:random-module] and the [BFT module][research:bft-module].
...
Here, `/` represents integer division, `isValidSeedReveal` is the function exposed by the [random module][research:random-module] and `impliesMaximalPrevotes` is the function exposed by the [BFT module][research:bft-module#specs].
...
After a block `b` is executed, the `mint` function exposed by the [token module][research:token-module] to assign the reward to the block generator as:
...
[research:bft-module#specs]: https://research.lisk.com/t/introduce-bft-module/321#specification-5
[research:random-module]: https://research.lisk.com/t/define-state-and-state-transitions-of-random-module/311
[research:token-module]: https://research.lisk.com/t/introduce-an-interoperable-token-module/295#mint-64
