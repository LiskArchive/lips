...
def afterTransactionsExecute(b: Block):
    ...
    if blockReward > 0:
        ...
        if not Token.userSubstoreExists(generatorAddress, TOKEN_ID_REWARD):
            Token.initializeUserAccountForBlockGenerator(generatorAddress, TOKEN_ID_REWARD)

        Token.mint(generatorAddress, TOKEN_ID_REWARD, blockReward)
