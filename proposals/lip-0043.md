...
def execute(trs: Transaction) -> None:
    ...
    # Emit chain registered event.
    emitEvent(
        moduleID = MODULE_ID_INTEROPERABILITY,
        typeID = TYPE_ID_CHAIN_STATUS_REGISTERED,
        data = {
            "chainID": chainID,
            "name": trs.params.name,
            "validators": trs.params.initValidators
        },
        topics=[senderAddress, chainID]
    )
...
def execute(trs: Transaction) -> None:
    ...
    emitEvent(
        ...
        data = {
            ...
            "name": MAINCHAIN_NAME,
            "validators": trs.params.mainchainValidators
        },
        topics=[senderAddress, MAINCHAIN_ID]
    )
