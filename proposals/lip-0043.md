...
The mainchain registration command sets certain parameters in the sidechain related to the interoperability module and initializes the corresponding mainchain data structures. This command requires the approval of the validators of the sidechain. They have to agree on the content of this command and add their aggregated signatures accordingly. It is important that the validators of the sidechain make sure that they are signing the registration command with the right information from the mainchain, otherwise, the sidechain interoperable functionality may be unusable.
...
The `signature` property is an aggregated signature of the validators of the sidechain. It ensures that the validators of the sidechain agree on registering the mainchain in the sidechain.
