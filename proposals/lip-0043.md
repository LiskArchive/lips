...
def execute(trs: Transaction) -> None:
    ...
    sidechainChannel = {
        ...
        "minReturnFeePerByte": MIN_RETURN_FEE_PER_BYTE
    }
    ...
    create an entry in the registered names substore with
        storeKey = trs.params.name.encode('ascii')
