...
Calling a function `fct` from a module `module` is represented by `module.fct(required inputs)`.
In this LIP, functions from the [Validators module][validatorsModule] and the [BFT module][BFTModule] are used.
