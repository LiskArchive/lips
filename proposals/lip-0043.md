...
When a new sidechain is registered on the mainchain via a sidechain registration command, it is assigned a chain ID, a unique integer that identifies the sidechain in the ecosystem.
...
| `TAG_CHAIN_REG_MESSAGE`               | bytes  | ASCII encoded string `“LSK_CHAIN_REGISTRATION_”`.| Message tag ofr chain registration message  |
...
[lip-0045#chain-substore]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0049.md#chain-data-substore
[lip-0045#channel-substore]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0049.md#channel-data-substore
[lip-0045#validators-substore]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0049.md#chain-validators-substore
[lip-0045#names-substore]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0049.md#registered-names-substore
[lip-0045#networkIDs-substore]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0049.md#registered-network-ids-substore
