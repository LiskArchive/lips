...
* Notation: For the rest of this proposal let `registeredBLSKeys(blsKey)` be the entry in the registered BLS keys substore identified by the store key `blsKey`, `validatorAddressSchema` schema.
