...
| `COMMAND_SIDECHAIN_REG`                    | bytes | 0x0000                    | Command ID of sidechain registration command.                    |
| `COMMAND_MAINCHAIN_REG`                    | bytes | 0x0001                    | Command ID of mainchain registration command.                    |
| `COMMAND_SIDECHAIN_CCU`                    | bytes | 0x0002                    | Command ID of sidechain cross-chain update command.              |
| `COMMAND_MAINCHAIN_CCU`                    | bytes | 0x0003                    | Command ID of mainchain cross-chain update command.              |
| `COMMAND_STATE_RECOVERY`                   | bytes | 0x0004                    | Command ID of state recovery initialization command.             |
| `COMMAND_MESSAGE_RECOVERY`                 | bytes | 0x0005                    | Command ID of message recovery command.                          |
| `COMMAND_STATE_RECOVERY_INITIALIZATION`    | bytes | 0x0006                    | Command ID of message recovery initialization command.           |
| `COMMAND_MESSAGE_RECOVERY_INITIALIZATION`  | bytes | 0x0007                    | Command ID of initiate recovery command.                         |
| `CROSS_CHAIN_COMMAND_REGISTRATION`         | bytes | 0x0000                    | Cross-chain command ID of chain registration CCM.                |
| `CROSS_CHAIN_COMMAND_CHANNEL_TERMINATED`   | bytes | 0x0001                    | Cross-chain command ID of channel terminated CCM.                |
| `CROSS_CHAIN_COMMAND_SIDECHAIN_STATUS_TERMINATED` | bytes | 0x0002                    | Cross-chain command ID of sidechain terminated CCM.              |
| **Chain Status**                              |        |                      |                                                                  |
...
| `CROSS_CHAIN_COMMAND_LENGTH`      | uint32  | 2       | Length in bytes of type `ModuleID`.|
...
def isLive(chainID: ChainID) -> bool:
    ...
    if ownChainAccount.ID == CHAIN_ID_MAINCHAIN:
