...
| `CrossChainCommand` | string   |   | Name of a cross-chain command.   |
...
This event has `name = EVENT_NAME_CCM_PROCESSED`. This event is emitted when a CCM is sent or processed.
