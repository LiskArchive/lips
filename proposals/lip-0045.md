...
| `SUBSTORE_PREFIX_REGISTERED_NETWORK_IDS`         | bytes  | 0xf000               | Substore prefix of the chain network IDs substore.                  |
...
* The substore prefix is set to `SUBSTORE_PREFIX_REGISTERED_NETWORK_IDS`.
