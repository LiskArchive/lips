...
* compute the random seed to be used as source of randomness to re-order the generator list for a new round (both in PoA and PoS chains) and to select the standby delegates (in certain PoS chains as well as the Lisk mainchain).
