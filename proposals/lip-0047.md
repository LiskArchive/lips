...
This module does not define any internal functions.
...
def afterTransactionsExecute(b: Block) -> None:
    if b.header.height == chainProperties.roundEndHeight:
        ...
        nextValidators  = PoS.shuffleValidatorsList(snapshotStore(0).validators, randomSeed)
...
* `shuffleValidatorsList` is a function exposed by the [PoS module][lip-0057#shuffle-validators-list].
* `setValidatorParams` is a function exposed by the [Validators module][lip-0044#setvalidatorparams].
...
[lip-0057#shuffle-validators-list]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#shufflevalidatorslist
