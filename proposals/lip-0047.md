...
Let `chainId` be the byte array with the chain ID of the chain. A transaction with module name `MODULE_NAME_POA` and command name `COMMAND_UPDATE_AUTHORITY` is processed as follows:
