...
The function `verifyWeightedAggSig` is specified in [LIP 0062][https://github.com/LiskHQ/lips/blob/main/proposals/lip-0062.md#signing-and-verifying-with-bls], `getValidatorKeys` is exposed by the [Validators module][lip-0044]. The schema `validatorSignatureMessageSchema` is:
