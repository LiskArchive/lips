...
```python
def initGenesisState(b: Block) -> None:
...
def verify(trs: Transaction) -> None:
    ...
    if h < MAX_BLOCK_HEIGHT_ZERO_FEE_PER_BYTE:
	    # Set MIN_FEE_PER_BYTE = 0 for the first MAX_BLOCK_HEIGHT_ZERO_FEE_PER_BYTE blocks after the genesis block has been generated.
        MIN_FEE_PER_BYTE = 0
