...
The available part of the message fee is left to the relayer to cover the cost of CCU execution and to incentivize its participation in CCM relaying. Also, since a CCU is a regular transaction, note that the relayer pays transaction fees for posting the CCU in the receiving chain. 
