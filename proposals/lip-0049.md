...
def apply(ccu: Transaction, ccm: CCM) -> None:
    ...
    try:
        ...
        emitEvent(
            ...
            data = {"ccmID": ccmID, "result": CCM_DISCARDED, "code": INVALID_CCM},
    ...
    try:
        ...
        emitEvent(
            module = MODULE_NAME_INTEROPERABILITY,
            name = EVENT_NAME_CCM_PROCESSED,
            data = {"ccmID": ccmID, "result": CCM_APPLIED, "code": STATUS_CODE_OK},
            topics = [ccm.sendingChainID, ccm.receivingChainID]
        )
    except:
...
def forward(ccu: Transaction, ccm: CCM) -> None:
    ...
    if not isLive(ccm.receivingChainID):
        emitEvent(
            module = MODULE_NAME_INTEROPERABILITY,
            name = EVENT_NAME_CCM_PROCESSED,
            data = {"ccmID": ccmID, "result": CCM_DISCARDED, "code": STATUS_CODE_CHANNEL_UNAVAILABLE},
            topics = [ccm.sendingChainID, ccm.receivingChainID]
        )
    ...
    emitEvent(
        module = MODULE_NAME_INTEROPERABILITY,
        name = EVENT_NAME_CCM_PROCESSED,
        data = {"ccmID": ccmID, "result": CCM_FORWARDED, "code": STATUS_CODE_OK},
        topics = [ccm.sendingChainID, ccm.receivingChainID]
    )
```
