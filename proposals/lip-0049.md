...
crossChainMessageSchema = {
    ...
    "properties": {
        ...
        "crossChainCommandID": {
            "dataType": "bytes",
            "length": CROSS_CHAIN_COMMAND_LENGTH,
            "fieldNumber": 3
        },
        "sendingChainID": {
            "dataType": "bytes",
...
* `moduleID = MODULE_ID_INTEROPERABILITY`,
* `crossChainCommandID  = CROSS_CHAIN_COMMAND_CHANNEL_TERMINATED`.
...
* `moduleID = MODULE_ID_INTEROPERABILITY`,
* `crossChainCommandID  = CROSS_CHAIN_COMMAND_REGISTRATION`.
...
* `moduleID = MODULE_ID_INTEROPERABILITY`.
* `crossChainCommandID  = CROSS_CHAIN_COMMAND_SIDECHAIN_STATUS_TERMINATED`.
