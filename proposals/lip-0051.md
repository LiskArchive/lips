...
#### initializeUserAccountForBlockGeneratorInternal

```python
def initializeUserAccountForBlockGeneratorInternal(
    address: Address,
    tokenID: TokenID
    ) -> None:
...
#### initializeUserAccountForBlockGenerator

```python
def initializeUserAccountForBlockGenerator(
    address: Address,
    tokenID: TokenID
) -> None:
    ...
    initializeUserAccountForBlockGeneratorInternal(address, tokenID)
```
