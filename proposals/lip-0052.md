...
This function checks, for a provided NFT ID, whether an NFT exists and returns NFT and user substores information.
...
This function returns a list of all escrowed native NFTs for a given chain ID.
