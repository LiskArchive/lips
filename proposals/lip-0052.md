...
This function returns NFT substore information for a provided NFT ID.

#### getNFTs 

This function returns information about all NFTs owned by a specific user.

#### hasNFT

This function returns a boolean value indicating whether an NFT is owned by a specific user.

#### getEscrowedNFTIDs

This function returns a list of all escrowed native NFTs.
