...
All interoperability constants are defined in [LIP 0045][lip-0045#constants]. `SMTVerifyInclusionProof` is the `verify_inclusion_proof` function specified in [LIP 0039][lip-0039].
