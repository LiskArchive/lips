...
def execute(trs: Transaction) -> None:
    ...
    if inboxUpdate != {} and len(inboxUpdate.crossChainMessages) > 0:
    ...
    validators(sidechainID) = {
        "activeValidators" : updateActiveValidators(sidechainValidators, trs.params.activeValidatorsUpdate),
        "certificateThreshold": newCertificateThreshold
    }
    ...
    if messageWitness != {}:
        ...
        channel(sidechainID).partnerChainOutboxRoot = calculateRootFromRightWitness(inbox.size, inbox.appendPath, messageWitness.siblingHashes)
    else:
