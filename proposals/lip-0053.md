...
def verifyValidatorsUpdate(ccu: CCU) -> None:
    ...
    for idx, blsKey in enumerate(allBLSKeys):
        ...
        if blsKey in blsKeysUpdate:
            ...
            # All new validators must have a positive BFT weight.
            if bftWeightsUpdate[index] == 0:         # index is the position in bftWeightsUpdate array where the BFT weight of current validator is specified
