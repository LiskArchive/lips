...
def verify(trs: Transaction) -> None:
    ...
    if ownChainAccount.chainID == getMainchainID() and chainAccount(ccu.params.sendingChainID).status == CHAIN_STATUS_REGISTERED and ccu.params.inboxUpdate is not empty:
