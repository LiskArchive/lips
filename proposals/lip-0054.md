...
def verify(trs: Transaction) -> None:
    ...
    # bit a of an encoded index in idxs in order to get the position in the tree. Encoded indices
    # equal to zero are also not valid here as they represent non-existing entries.
