...
* Let `smtVerifyInclusionProof` be the function specified in [LIP 0039][lip-0039].
...
* `idxs`: The indices of the messages to be recovered (encoded as specified in [LIP 0031][lip-0031##representation-of-indices]).
...
[lip-0031##representation-of-indices]: https://github.com/LiskHQ/lips/blob/main/proposals/lip-0031.md#representation-of-indices
