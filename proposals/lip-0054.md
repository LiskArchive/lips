...
This LIP specifies three commands for Lisk mainchain. These commands are part of the [Interoperability module][lip-0045], with `module = MODULE_NAME_INTEROPERABILITY`.
...
* `module`: The ID of the recoverable module.
        ...
        if ccm.receivingChainID == ownChainAccount.chainID and (ccm.module, ccm.crossChainCommand) is supported:
            ...
            try: 
                ...
                emitEvent(
                    ...
                    data = {"ccmID": ccmID, "status": CCM_PROCESSED_STATUS_COMMAND_RECOVERY_APPLIED},
                ...
                emitEvent(
                    module = MODULE_NAME_INTEROPERABILITY,
                    name = EVENT_NAME_CCM_PROCESSED,
                    data = {"ccmID": ccmID, "status": CCM_PROCESSED_STATUS_COMMAND_RECOVERY_FAILED},
                    topics = [ccm.sendingChainID, ccm.receivingChainID]
                )
            ...
            emitEvent(
                module = MODULE_NAME_INTEROPERABILITY,
                name = EVENT_NAME_CCM_PROCESSED,
                data = {"ccmID": ccmID, "status": CCM_PROCESSED_STATUS_COMMAND_RECOVERY_FORWARDED},
                topics = [ccm.sendingChainID, ccm.receivingChainID]
            )
        else: 
            emitEvent(
                module = MODULE_NAME_INTEROPERABILITY,
                name = EVENT_NAME_CCM_PROCESSED,
                data = {"ccmID": ccmID, "status": CCM_PROCESSED_STATUS_COMMAND_RECOVERY_DISCARDED},
                topics = [ccm.sendingChainID, ccm.receivingChainID]
            )
```
...
```python
def execute(trs: Transaction) -> None:
    channel = decode(channelSchema, trs.params.channel)
