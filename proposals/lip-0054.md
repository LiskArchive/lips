...
interopAccKey = MODULE_ID_INTEROPERABILITY + STORE_PREFIX_CHAIN_DATA + trs.params.chainID
...
channelKey = MODULE_ID_INTEROPERABILITY + STORE_PREFIX_CHANNEL_DATA + MAINCHAIN_ID
