...
In [LIP 0023][lip-0023] the [locking period][lip-0023#locking-period] for unstaked tokens was set to roughly 5.5 hours (2000 blocks) for the lisk mainchain. The sole protocol change in this LIP is to change this value to 3 days, by setting `LOCKING_PERIOD_STAKING` to `25.920 = 3 * 24 * 3600 // BLOCK_TIME` blocks.    
