...
|------|------|------------|-------------|
| `BlockHeader` | object   | Must follow the [`blockHeaderSchema`][lip-0055#block-header-json-schema] schema defined in LIP 0055.| The header of a block. |
...
def updateSnapshotSubstore(height: uint32)-> None:
    ...
    delete any entries from the snapshot substore snapshotStore(x) for x <= roundNumber(height)-3
