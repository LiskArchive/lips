...
| `FAIL_SAFE_INACTIVE_WINDOW` | uint32 | 120960 = 14x24x360 | The length of the inactivity window used in the fail safe banning mechanism, measured in number of blocks. |
