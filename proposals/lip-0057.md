...
| `PUNISHMENT_WINDOW_SELF_STAKING` | uint32 | 725760 = 3  * PUNISHMENT_WINDOW_STAKING | The punishment period for self-stakes, i.e., how many blocks after misbehavior report punished validators can unlock their self-unstaked tokens. |
