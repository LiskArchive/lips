...
| `genesisTimestamp` | This variable holds the timestamp of the genesis block of the blockchain. It is generally available in the context of the consensus domain and initialized during the genesis block processing or, afterwards, at the beginning of starting the node. |
...
def getGeneratorAtTimestamp(timestamp, currentHeight):
    elapsedTime = timestamp - genesisTimestamp
...
* The variables regarding the genesis block are initialized as follows:
