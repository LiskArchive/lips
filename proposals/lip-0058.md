...
The BFT store is organized in the two substores described below.
...
These parameters are forwarded to the replication layer and the BFT parameters store is updated accordingly.
