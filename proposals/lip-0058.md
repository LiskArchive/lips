...
* Notation: We let `bftVotes` denote the object stored in the BFT store for the substore prefix `SUBSTORE_PREFIX_BFT_VOTES` and store key equal to empty bytes.
