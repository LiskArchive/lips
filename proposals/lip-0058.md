...
def getGeneratorAtTimestamp(timestamp):
    ...
    currentValidatorList = getCurrentValidators()
...
def getValidator(address, height):
    getBFTParametersInternal(currentHeight).validators
