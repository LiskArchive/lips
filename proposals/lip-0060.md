...
Note that in contrast to the block processing in [LIP 0055][lip-0055#asset-validation], for the genesis block there is no limitation on the size of the data property of every entry.
