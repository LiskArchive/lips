...
| `MIN_CERTIFICATE_HEIGHT`|  For sidechains built with Lisk SDK, `genesisHeight`. For the mainchain in the Lisk Core v4 migration, `(POS_INIT_ROUNDS + LSK_BFT_BATCH_SIZE - 1) * LSK_BFT_BATCH_SIZE +1`  | The smallest height for which a certificate can be produced.|
