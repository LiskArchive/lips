...
Here, `MAX_LENGTH_AGGREGATION_BITS` is calculated as `(MAX_NUM_VALIDATORS + 8 - 1) // 8`, where `MAX_NUM_VALIDATORS` is a constant defined in [LIP 0045][lip-0045#notation-and-constants].
