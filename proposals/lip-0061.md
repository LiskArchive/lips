...
* **active validator:** A validator that can propose blocks and contribute to block finality by casting consensus stakes for blocks. Active validators are defined per round and may change from round to round.
