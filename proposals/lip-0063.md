...
48 bytes all set to 0
  ...
  <tr>
   ...
   <td>587 = 7*24*3600 // (BLOCK_TIME * (NUMBER_ACTIVE_VALIDATORS + NUMBER_STANDBY_VALIDATORS))
   </td>
...
| [LIP 0061](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0061.md#constants) | `MIN_CERTIFICATE_HEIGHT` | `HEIGHT_SNAPSHOT + 1 + (POS_INIT_ROUNDS + NUMBER_ACTIVE_VALIDATORS - 1) * (NUMBER_ACTIVE_VALIDATORS + NUMBER_STANDBY_VALIDATORS) = HEIGHT_SNAPSHOT + 1 +  6239740` |
...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `WEIGHT_SCALE_FACTOR` | 1000 * (10)^8 |
...
| [Dynamic Reward Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0071.md#notation-and-constants) | `FACTOR_MINIMUM_REWARD_ACTIVE_VALIDATORS` | 1000 |
