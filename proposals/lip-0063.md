...
This value will be used for every validator account in the snapshot block.
  ...
  <tr>
   ...
   <td>The chain ID of the mainchain of Lisk Mainnet, see [LIP 0037](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0037.md#chain-identifiers).
   </td>
  </tr>
  <tr>
  <tr>
   ...
   <td>Token ID of the LSK token for Mainnet, see [LIP 0051](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0051.md#token-id).
   </td>
  </tr>
  <tr>
...
Note that if the migration is tested for a different network, e.g., Betanet or Testnet, the first byte of the constants `CHAIN_ID_MAINCHAIN` and `TOKEN_ID_LSK` need to be changed to the appropriate chain-identifier prefix, see [LIP37](https://github.com/LiskHQ/lips/blob/jan_fix-chain-id-token-id/proposals/lip-0037.md#chain-identifiers-1) for details.
