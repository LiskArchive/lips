...
This value will be used for every validator account in the snapshot block.
  ...
  <tr>
   <td><code><a href="https://github.com/LiskHQ/lips/blob/main/proposals/lip-0051.md#token-id">TOKEN_ID_LSK</a></code>
   </td>
   <td>bytes
   </td>
   <td><code>0x 00 00 00 00 00 00 00 00</code>
   </td>
   <td>Token ID of the LSK token for Mainnet.
   </td>
  </tr>
  <tr>
...
Note that if the migration is tested for a different network, e.g., Betanet or Testnet, the first byte of the constant `TOKEN_ID_LSK` needs to be changed to the appropriate chain-identifier prefix, see [LIP37](https://github.com/LiskHQ/lips/blob/jan_fix-chain-id-token-id/proposals/lip-0037.md#chain-identifiers-1) for details.
