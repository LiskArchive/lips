...
| [LIP 0061](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0061.md#constants) | `MIN_CERTIFICATE_HEIGHT` | `(POS_INIT_ROUNDS + NUMBER_ACTIVE_VALIDATORS - 1) * ROUND_LENGTH +1 =  6239741` |
