...
<table>
  ...
  <tr>
   ...
   <td>A dummy value for a <a href="https://github.com/LiskHQ/lips/blob/main/proposals/lip-0038.md#public-key-registration-and-proof-of-possession">proof of possession</a>. The PoS module requires that each validator account contained in a snapshot/genesis block has such an entry. However, the proofs of possession are not verified for this particular snapshot block.
<p>
...
48 bytes all set to 0
  ...
  <tr>
   ...
   <td><code>587 = 7*24*3600 // (BLOCK_TIME * (NUMBER_ACTIVE_VALIDATORS + NUMBER_STANDBY_VALIDATORS))</code>
   </td>
...
8. [Dynamic Reward](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0071.md)
...
| [LIP 0061](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0061.md#constants) | `MIN_CERTIFICATE_HEIGHT` | `HEIGHT_SNAPSHOT + 1 + (POS_INIT_ROUNDS + NUMBER_ACTIVE_VALIDATORS - 1) * (NUMBER_ACTIVE_VALIDATORS + NUMBER_STANDBY_VALIDATORS) = HEIGHT_SNAPSHOT + 1 + 70761` |
| [LIP 0068](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0068.md#constants) | `MAX_PARAMS_SIZE` | 14 KiB (14*1024 bytes) |
| [LIP 0070](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0070.md#constants) | `COMMISSION_INCREASE_PERIOD` | 241,920 |
...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `FAIL_SAFE_INACTIVE_WINDOW` | 120,960 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `LOCKING_PERIOD_STAKING` | 25,920 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `LOCKING_PERIOD_SELF_STAKING` | 241,920 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `PUNISHMENT_WINDOW_STAKING` | 241,920 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `PUNISHMENT_WINDOW_SELF_STAKING` | 725,760 |
...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `MIN_WEIGHT` | 1,000 x (10^8)
...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `VALIDATOR_REGISTRATION_FEE` | 10 * (10^8) |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `WEIGHT_SCALE_FACTOR` | 1,000 * (10)^8 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `MAX_BFT_WEIGHT_CAP ` | 1,000 |
...
| [Fee Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0048.md#notation-and-constants) | `MIN_FEE_PER_BYTE` | 1,000 |
| [Fee Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0048.md#notation-and-constants) | `MAX_BLOCK_HEIGHT_ZERO_FEE_PER_BYTE` | 0 |
| [Fee Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0048.md#notation-and-constants) | `TOKEN_ID_FEE` | `TOKEN_ID_LSK` |
| [Fee Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0048.md#notation-and-constants) | `ADDRESS_FEE_POOL` | None |
| [Token Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0051.md#constants-and-notations) | `USER_ACCOUNT_INITIALIZATION_FEE` | 5,000,000 |
| [Token Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0051.md#constants-and-notations) | `ESCROW_ACCOUNT_INITIALIZATION_FEE` | 5,000,000 |
| [Dynamic Reward Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0071.md#notation-and-constants) | `FACTOR_MINIMUM_REWARD_ACTIVE_VALIDATORS` | 1,000 |
| [Dynamic Reward Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0071.md#notation-and-constants) | `TOKEN_ID_DYNAMIC_BLOCK_REWARD` | `TOKEN_ID_LSK` |
| [Dynamic Reward Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0071.md#notation-and-constants) | `REWARD_REDUCTION_FACTOR_BFT` | 4 |
...
[Update Lisk Core v4 migration strategy](https://github.com/LiskHQ/lisk-migrator/issues/36)
