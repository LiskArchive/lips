...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `FACTOR_SELF_STAKES` | 10 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `BASE_STAKE_AMOUNT` | `10 * (10)^8` |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `MAX_LENGTH_NAME` | 20 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `MAX_NUMBER_SENT_STAKES` | 10 |
...
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `LOCKING_PERIOD_STAKES` | 26,000 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `LOCKING_PERIOD_SELF_STAKES` | 260,000 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `PUNISHMENT_WINDOW_STAKES` | 260,000 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `PUNISHMENT_WINDOW_SELF_STAKES` | 780,000 |
| [PoS Module](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0057.md#notation-and-constants) | `MISBEHAVIOR_REPORT_LIMIT_BANNED` | 5 |
...
| [Dynamic Block Reward Module](https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip-add-introduce-dynamic-block-rewards.md#notation-and-constants) | `FACTOR_MINIMUM_REWARD_ACTIVE_VALIDATORS` | 1000 |
...
def getLockedBalances(account):
    amount = 0
    for stake in account.pos.sentStakes:
        amount += stake.amount
...
def createValidatorsArray():
    ...
    for every account in accounts:
        ...
        validator.misbehaviorReportHeights = account.pos.validator.misbehaviorReportHeights
...
def getSentStakes(account):
    sentStakes = account.pos.sentStakes
    for every stake in sentStakes:
        stake.stakeSharingCoefficients = [
            {"tokenID": TOKEN_ID_LSK, "coefficient": Q96_ZERO}
        ]
    return sentStakes
...
def createStakersArray():
    stakers = []
    for every account in accounts:
        if account.pos.sentStakes == [] and account.pos.unlocking == []:
            continue
        staker = {}
        staker.address = account.address
        staker.sentStakes = getSentStakes(account)
