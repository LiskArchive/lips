...
| `MAX_MODULE_NAME_LENGTH`               | integer | `16`                                                | Maximum length of a module name.                                         |
| `MAX_EVENT_NAME_LENGTH`               | integer | `16`                                                | Maximum length of an event name.                                         |
...
| `EVENT_NAME_STANDARD`             | string   | `executionResult`                                              | Name of standard event emitted at the end of transaction execution.               |
...
eventSchema = {
    "type": "object",
    "required": ["module", "name", "data", "topics", "index"],
    "properties": {
        "module": {
            "dataType": "string",
...
* `module`: The `module` of the transaction.
* `name`: The constant `EVENT_NAME_STANDARD`.
