...
However, events emitted during the [processing of a cross-chain message][lip-0053#ccu-processing] contain the ID of the cross-chain message as default topic instead of the ID of the cross-chain update transaction that contained the cross-chain message.
