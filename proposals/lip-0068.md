...
- [Improve framework on-chain architecture to support new state model](https://github.com/LiskHQ/lisk-sdk/issues/6554)
- https://github.com/LiskHQ/lisk-sdk/tree/development/elements/lisk-chain
