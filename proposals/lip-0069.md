...
Application hooks are module methods which are called during the block execution. These hooks can access the current state, the block header being currently executed and its block assets, and make state mutations.
