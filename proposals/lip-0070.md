...
```python
def getExpectedReward(validatorAddress: Address, validatorReward: uint64, stakeAmount: uint64) -> uint64:
    ...
    totalStake = Q96(validatorStore(validatorAddress).totalStake + stakeAmount)
