...
=======
def getExpectedValidatorBlockReward(validatorAddress: Address) -> tuple[uint64, uint64, uint64, uint64]:
>>>>>>> bed8ae55a3d45739a3d2f681f1b45cd9ce2fdf0b
    validatorParams = Validators.getValidatorParams()
    totalBftWeight = sum(validator.bftWeight for validator in validatorParams.validators)
    ...
    dailyReward =   86400 // (Pos.getRoundLength * BLOCK_TIME)
    monthlyReward = 2592000 // (Pos.getRoundLength * BLOCK_TIME) 
    yearlyReward = 31536000 // (Pos.getRoundLength * BLOCK_TIME)
