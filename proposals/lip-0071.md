...
The token for rewards on the Lisk mainchain is the LSK token. The value of `TOKEN_ID_DYNAMIC_BLOCK_REWARD` is defined in [LIP 0063](https://github.com/LiskHQ/lips/blob/main/proposals/lip-0063.md#constants-1).
