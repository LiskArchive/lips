...
def getValidatorBlockReward(blockHeader: BlockHeader) -> uint64:
    ...
    minimumRewardActiveValidators = (FACTOR_MINIMUM_REWARD_ACTIVE_VALIDATORS * getDefaultRewardAtHeight(blockHeader.height))// DECIMAL_PERCENT_FACTOR
    ...
    if validator.bftWeight > 0:
        stakeRewardActiveValidators = numberActiveValidators * (getDefaultRewardAtHeight(blockHeader.height) -  minimumRewardActiveValidators) 
