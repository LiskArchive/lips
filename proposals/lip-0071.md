...
* `reduction`: an integer indicating whether the reward is reduced. Possible values are `REWARD_NO_REDUCTION`, `REWARD_REDUCTION_SEED_REVEAL`, and `REWARD_REDUCTION_MAX_PREVOTES`.
