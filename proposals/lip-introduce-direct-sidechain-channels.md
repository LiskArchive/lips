...
This LIP introduces two new commands that extend the standard interoperability protocol and allow sidechains to exchange cross-chain messages directly, without routing them via the mainchain.
