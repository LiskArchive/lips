...
- [This spreadsheet](lip-replace_static_fee_system_by_dynamic_fee_system/spam_attack_cost_sheet.pdf) studies the cost of broadcasting a number of balance transactions depending on `minFeePerByte` and the price of LSK in USD.
...
![reward3](lip-replace_static_fee_system_by_dynamic_fee_system/reward_3.png)

![reward2](lip-replace_static_fee_system_by_dynamic_fee_system/reward_2.png)

![reward1](lip-replace_static_fee_system_by_dynamic_fee_system/reward_1.png)
