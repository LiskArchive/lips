```
LIP: LIP-usman-improve_processing_of_transactions
Title: Improve processing of transactions 
Author: Usman Khan, usman@lightcurve.io
Type: Process
Module: Transaction Pool, Transactions
Created: <2018-09-07>
Updated: -
```
...
```
In the case of a delegate registration transaction, as described above, the details of the sender account and information on whether the username already exists in the blockchain is required.
Using the information returned from `getRequiredAttributes`, the database module executes the queries for all transactions in parallel and collects the data in memory.
